...
HD_PWD='C:/Users/Firev/OneDrive/Documents/GitHub/Steven-Jugler-ENES-246-501/Steven ENES/14Rings/1_Ring/Ring.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleRing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simpleRing.tcl -notrace
