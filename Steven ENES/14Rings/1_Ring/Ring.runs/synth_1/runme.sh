...
HD_PWD='C:/Users/Firev/OneDrive/Documents/GitHub/Steven-Jugler-ENES-246-501/Steven ENES/14Rings/1_Ring/Ring.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleRing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simpleRing.tcl
